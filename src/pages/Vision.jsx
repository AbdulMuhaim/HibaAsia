      ...
      <div className="grid lg:grid-cols-2 gap-10 border-b-2  max-w-[1315px] p-3 sm:py-20 sm:px-28">
        ...
        <div className="w-full flex flex-col items-center justify-center mx-auto">
          ...
          <h1 className="text-4xl  font-bold  mb-6">
            ...
            <h2 className=" text-xl mb-3">Compassion</h2>
            ...
            <h2 className=" text-xl mb-3">Patient-Centricity</h2>
            <p className=" president-message mb-3">
            ...
            <h2 className=" text-xl mb-3">Collaboration</h2>
            <p className=" president-message mb-3">
            ...
            <h2 className=" text-xl mb-3">Integrity</h2>
            <p className=" president-message mb-3">
            ...
            <h2 className="text-xl mb-3">Quality</h2>
            <p className=" president-message">
