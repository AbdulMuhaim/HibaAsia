            ...
            <div className="w-full h-full">
              ...
              <div className="w-full">
                <ul className="list-disc list-inside president-message max-w-4xl">
                  <li className="mb-5">{t("founderPara1")}</li>
                  <li className="mb-5">{t("founderPara2")}</li>
                  <li className="">{t("founderPara3")}</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 border-b-2  max-w-[1315px] sm:py-20 p-3 sm:px-28">
          ...
          <div className="w-full flex flex-col items-center justify-center mx-auto">
            <div className="w-full h-full">
              ...
              <div className="w-full">
                <ul className="list-disc list-inside president-message max-w-4xl">
                  <li className="mb-5">{t("mdPara1")}</li>
                  <li className="">{t("mdPara2")}</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 border-b-2  max-w-[1315px] p-3 sm:py-20 sm:px-28">
          ...
          <div className="w-full flex flex-col items-center justify-center mx-auto">
            ...
            <div className="w-full h-full ">
              ...
              <div className="w-full">
                <ul className="list-disc list-inside president-message max-w-4xl">
                  <li className="mb-5">{t("ceoPara1")}</li>
                  <li className="">{t("ceoPara2")}</li>
                </ul>
              </div>
            </div>
          </div>
