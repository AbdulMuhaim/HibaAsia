  ...
  return (
    <section className="text-center py-20 flex justify-center items-center">
      <div className="max-w-[1150px]">
        ...
        <p className="opacity-70 px-8 mb-12">{t("serviceDescription")}</p>
        <div className="flex flex-wrap justify-center gap-1 ">
          {services.map((service, index) => (
            <div
              key={index}
              className=" rounded-lg p-2 overflow-hidden group hover:scale-105 transition duration-300 ease-in-out"
            >
              <img
