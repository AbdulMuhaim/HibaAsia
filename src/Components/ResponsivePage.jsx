...
const ResponsivePage = () => {
  return (
    ...
    <div className="flex flex-row items-center md:items-start">
      ...
      <div className="absolute hidden md:flex left-1/2 transform -translate-x-1/2 -translate-y-48 w-[90%]  max-w-[1110px] bg-sky-800 text-white px-6 pt-10 pb-7 shadow-lg">
